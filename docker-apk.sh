...
if [[ "$OSTYPE" == "cygwin" ]]; then
    winpty docker run                                                                                                                     \
        ...
        --interactive --tty                                                                                                               \
        --mount type=bind,src="$(cygpath -w "$(pwd)/.abuild")",dst="/home/$_AUTHOR_USER/$_PROJECT_NAME/.abuild",readonly                  \
    ...
    docker run                                                                                                      \
        ...
        --privileged=true --cap-add=SYS_ADMIN                                                                       \
        --interactive --tty                                                                                         \
        --mount type=bind,src="$(pwd)/.abuild",dst="/home/$_AUTHOR_USER/$_PROJECT_NAME/.abuild",readonly            \

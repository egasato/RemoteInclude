...
# Sets the SHA256 hash used inside PKGBUILD
function set_sha256_PKGBUILD() {
    ...
    gawk -v project_sha256="$1" -v project_name="$2" -v project_version="$3" -f "$__dirname/set_sha256_PKGBUILD.gawk" "$__dirname/../PKGBUILD" > "$__dirname/../PKGBUILD.tmp"

...
# Sets the project source url used inside PKGBUILD
function set_source_PKGBUILD() {
    ...
    gawk -v project_source="$1" -v project_name="$2" -v project_version="$3" -v project_name="$2" -f "$__dirname/set_source_PKGBUILD.gawk" "$__dirname/../PKGBUILD" > "$__dirname/../PKGBUILD.tmp"
